...
현재 안전관리자가 육안으로 일일이 수행해야 하는 현장 작업자의 보호장비 착용여부 확인 작업을, YOLO11 및 RT-DETR 을 통한 보호장비 탐지 모델 구축 및 Streamlit을 사용한 UI 구현으로 자동화하고 한 장소에서 실시간으로 확인할 수 있도록 함.
