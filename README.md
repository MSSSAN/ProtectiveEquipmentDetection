...
- 건설/제조 등의 산업 현장에는 안전보호장비 착용 규정이 존재하나 이를 준수하지 않는 사례가 발생함. 그러나 소수의 안전관리자가 모든 작업자의 안전보호장비 착용여부를 항상 확인하기는 어려움.
- 적절한 안전보호장비 착용시 방지하거나 완화할 수 있는 사고가, 미착용시에는 큰 상해나 인명피해로 이어질 수 있음.
- Object Detection 모델을 사용해 적합한 안전보호장비 착용 여부를 탐지할 수 있음. 이 경우, 안전관리자의 사각지대를 최대한 줄이고 현장 작업자의 안전보호장비 착용률을 높여 더 안전한 작업조건 조성에 기여할 수 있음.
