...
> **주제:** AI 컴퓨터비전 기술을 통해 작업자의 PPE(개인보호장비) 착용여부를 실시간으로 탐지하는 프로그램 제작.

---

## 0. 한 줄 요약

산업 현장에서 관리자가 육안으로 확인하던 작업자의 PPE 착용 여부를, YOLO11 및 RT-DETR 을 사용한 객체 탐지 기술로 자동화하고 Streamlit을 사용해 웹앱으로 실시간 확인할 수 있도록 함.
