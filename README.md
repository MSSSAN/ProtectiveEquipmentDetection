...
> **주제:** 작업자의 **PPE(개인보호장비) 착용/미착용 여부**를 AI 컴퓨터 비전 기술로 웹캠을 통해 실시간으로 탐지하는 프로그램을 Streamlit으로 구현
...
- 건설/제조 등의 산업 현장에는 안전보호장비 착용 규정이 존재하나 이를 준수하지 않는 사례가 발생하며, 소수의 안전관리자가 모든 작업자의 안전보호장비 착용여부를 항상 확인하기는 어려움.
- 적절한 안전보호장비 착용시 방지하거나 완화할 수 있는 사고가, 미착용시에는 큰 상해나 인명피해로 이어질 수 있음.
- Object Detection 모델을 사용해 적합한 안전보호장비 착용 여부를 탐지할 경우, 안전관리자의 사각지대를 최대한 줄이고 현장 작업자의 안전보호장비 착용률을 높여 더 안전한 작업조건 조성에 기여할 수 있음.
